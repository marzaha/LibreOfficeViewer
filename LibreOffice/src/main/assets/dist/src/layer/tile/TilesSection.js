...
var TilesSection = /** @class */ (function () {
    ...
    TilesSection.prototype.forEachTileInView = function (zoom, part, ctx, callback) {
        var docLayer = this.sectionProperties.docLayer;
        var tileRanges = ctx.paneBoundsList.map(docLayer._pxBoundsToTileRange, docLayer);
        if (app.file.fileBasedView) {
            var coordList = this.sectionProperties.docLayer._updateFileBasedView(true);
    ...
    TilesSection.prototype.haveAllTilesInView = function (zoom, part, ctx) {
        ...
        this.forEachTileInView(zoom, part, ctx, function (tile) {
    ...
    TilesSection.prototype.drawPageBackgroundWriter = function (ctx, rectangle, pageNumber) {
    ...
    TilesSection.prototype.drawPageBackgroundFileBasedView = function (ctx, top, bottom) {
        ...
        var startY = (partHeightPixels + gap) * (top > 0 ? top - 1 : 0);
        var rectangle;
        for (var i = 0; i <= bottom - top; i++) {
            ...
            this.context.fillText(String(i + top + 1), Math.round((2 * rectangle[0] + rectangle[2]) * 0.5) - ctx.viewBounds.min.x, Math.round((2 * rectangle[1] + rectangle[3]) * 0.5) - ctx.viewBounds.min.y, rectangle[2] * 0.4);
    ...
    TilesSection.prototype.drawPageBackgrounds = function (ctx) {
        ...
        */
        ...
        if (this.map._docLayer._docType === 'text') {
            ...
            var visibleBounds = this.containerObject.getDocumentBounds();
            var topVisible = Math.floor(visibleBounds[1] / partHeightPixels);
            var bottomVisible = Math.ceil(visibleBounds[3] / partHeightPixels);
    ...
    TilesSection.prototype.onDraw = function () {
        ...
        this.forEachTileInView(zoom, part, ctx, function (tile, coords) {
    ...
    TilesSection.prototype.forEachTileInArea = function (area, zoom, part, ctx, callback) {
        var docLayer = this.sectionProperties.docLayer;
        if (app.file.fileBasedView) {
            var coordList = docLayer._updateFileBasedView(true, area, zoom);
            for (var k = 0; k < coordList.length; k++) {
     ...
     */
    TilesSection.prototype.zoomLevelWithMaxContentInArea = function (area, areaZoom, part, ctx) {
    ...
    TilesSection.prototype.drawZoomFrame = function (ctx) {
        ...
        for (var k = 0; k < paneBoundsList.length; ++k) {
            ...
            this.forEachTileInArea(docRangeScaled, bestZoomSrc, part, ctx, function (tile, coords) {
                if (!tile || !tile.loaded || !docLayer._isValidTile(coords))
                    return false;
                ...
                if (cropWidth && cropHeight) {
                    canvasContext.drawImage(tile.el, tileOffset.x, tileOffset.y, // source x, y
    ...
    TilesSection.prototype.onMouseWheel = function () { return; };
    TilesSection.prototype.onMouseMove = function () { return; };
    TilesSection.prototype.onMouseDown = function () { return; };
    TilesSection.prototype.onMouseUp = function () { return; };
    TilesSection.prototype.onMouseEnter = function () { return; };
    TilesSection.prototype.onMouseLeave = function () { return; };
    TilesSection.prototype.onClick = function () { return; };
    TilesSection.prototype.onDoubleClick = function () { return; };
    TilesSection.prototype.onContextMenu = function () { return; };
    TilesSection.prototype.onLongPress = function () { return; };
    TilesSection.prototype.onMultiTouchStart = function () { return; };
    TilesSection.prototype.onMultiTouchMove = function () { return; };
    TilesSection.prototype.onMultiTouchEnd = function () { return; };
    TilesSection.prototype.onNewDocumentTopLeft = function () { return; };
    return TilesSection;
}());
